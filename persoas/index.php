...
// PAGINACION  --- intentar outra solución (?)
...
<div class="container pt-0">
  <div class="row my-4">
    <div class="col-md-6"><h2 class="text-primary">Persoas</h2></div>
    ...
    <nav class="navbar navbar-light my-4">
      <div class="container-fluid">
        ...
        <form class="d-flex" action="./busqueda.php" method="POST">
          ...
          !-- Buscador y botón buscar --
          <div class="input-group mb-3 mx-2 w-6" alt="Busca de persoas">
            <input id="campo" name="campo" class="form-control" type="text" placeholder="Busca" aria-label="Search">
            <input type="submit" id="enviar" name="enviar" value="Buscar" class="btn btn-primary text-white rounded-0">
          </div>
        </form>
      </div>
      ...
      <table class="table table-striped table-hover">
        <thead>
          <tr class="table-primary">
            ...
            <th class="text">Nacemento</th>
            <th class="text">Sexo</th>
            <th class="text">CP</th>
            <th class="text">Teléfono</th>
            <th class="text">Correo</th>
            <th class="text">Accións</th>
          </tr>
        </thead>
        ...
        <tbody>
          ...
          <?php while ($row = $result->fetch_assoc()) : ?>
            <tr>
             ...
             <!-- Iconos tabla -->
              <td class="d-flex"><a href="#"><a href="cidadan.php?id=<?php echo $row['id']; ?>"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye " viewBox="0 0 16 16">
                ...
                <a href="eliminar.php?id=<?php echo $row['id'] ?>"><svg xmlns="http://www.w3.org/2000/svg" alt="Eliminar rexistro" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
