...
<?php require_once '../inc/header.php'; ?>
  ...
  <div class="t-container">
    ...
    <ul class="t-contents">
      <li class="t-content">
        <form class="g-2 mt-4" method="POST" action="update.php" autocomplete="off">
          <!-- Datos persoais -->
          <div class="input-group">
            <span class="input-group-text d-inline d-sm-none d-md-block d-none d-sm-block text-uppercase">Nome e Apelidos</span><!-- OLLO! Norma CSS: un ID so se pode usar unha vez por paxina -->
            <input type="text" aria-label="nome" class="form-control border-0" id="nombre" name="nome" placeholder="Nome" value="<?php echo $row['nome']; ?>" required>
            <input type="text" aria-label="1º apelido" class="form-control" id="nombre" name="primeiro_apelido" placeholder="Primeiro Apelido" value="<?php echo $row['primeiro_apelido']; ?>" required>
            <input type="text" aria-label="2º apelido" class="form-control" id="nombre" name="segundo_apelido" placeholder="Segundo Apelido" value="<?php echo $row['segundo_apelido']; ?>" required>
            <span class="input-group-text d-none d-sm-block" id="basic-addon1">DNI/NIF:</span>
            <input type="text" class="form-control border-bottom"  id="nif" name="nif" placeholder="Número do DNI" pattern="[0-9]{8}+[A-Z]{1}" maxlength="9" placeholder="Número do DNI" value="<?php echo $row['nif']; ?>" required>
            </div>
          <!-- div class="col-md-4">
