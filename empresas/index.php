...
<body>
	...
	<div class="  mt-4 mb-3 text-center d-flex justify-content-center ">
        <h2 class=" text-primary bg-secondary w-25 border rounded">Empresas</h2>
        </div>
		<div class="container mb-4">
			<div class="row">
				...
				<div class="col">
					<a href="functions/nuevo.php" class="btn btn-primary"><svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor" class="bi bi-person-plus" viewBox="-2 0 18 18">
